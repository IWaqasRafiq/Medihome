...
const TopDoctors = () => {
    ...
    return (
        <div className='flex flex-col items-center my-6 gap-4 text-gray-900 md:mx-10'>
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-blue-50 text-gray-600 rounded-full mt-10 px-8 py-3'>Show more</button>
        </div>
    )
}
